...
bot = telegram.Bot(token='6452439883:AAFubdRKyRAl2SD9KynyVJgV-VgQ5KEmFuU') #Replace TOKEN with your token string

from telegram.ext import Updater, CommandHandler, MessageHandler, Filters

updater = Updater(token='6452439883:AAFubdRKyRAl2SD9KynyVJgV-VgQ5KEmFuU', use_context=True) #Replace TOKEN with your token string
